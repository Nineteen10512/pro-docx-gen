...
ACADEMIC_OVERRIDES.update(_doc_colors(
    "academic",
    chart_palette=["#1F3864", "#C0504D", "#2E75B6", "#7F604F"],
))
...
BUSINESS_OVERRIDES.update(_doc_colors(
    "business",
    chart_palette=["#2C3E50", "#E67E22", "#16A085", "#F1C40F"],
...
TEACHING_OVERRIDES.update(_doc_colors(
    "teaching",
    chart_palette=["#2E7D32", "#FFA000", "#42A5F5", "#9CCC65"],
    overrides={
        "color": {
            "accent": _rgb("#FFA000"),
...
TECH_OVERRIDES.update(_doc_colors(
    "tech",
    chart_palette=["#00D4FF", "#00C8FF", "#6C5CE7", "#00B894"],
...
DARK_OVERRIDES.update(_doc_colors(
    "dark",
    chart_palette=["#E91E63", "#9C27B0", "#3F51B5", "#00BCD4"],
    overrides={
        "color": {
...
MINIMAL_OVERRIDES.update(_doc_colors(
    "minimal",
    chart_palette=["#333333", "#666666", "#999999", "#BBBBBB"],
    overrides={
        "color": {
...
NATURE_OVERRIDES.update(_doc_colors(
    "nature",
    chart_palette=["#65A30D", "#A16207", "#CA8A04", "#16A34A"],
    overrides={
        "color": {
...
WARM_OVERRIDES.update(_doc_colors(
    "warm",
    chart_palette=["#B45309", "#D97706", "#DC2626", "#92400E"],
    overrides={
        "color": {
...
PREMIUM_OVERRIDES.update(_doc_colors(
    "premium",
    chart_palette=["#D4AF37", "#1C1917", "#B08D57", "#78716C"],
    overrides={
        "color": {
...
CHINESE_RED_OVERRIDES.update(_doc_colors(
    "chinese_red",
    chart_palette=["#C41E3A", "#D4AF37", "#8B0000", "#E67E22"],
    overrides={
        "color": {
...
OCEAN_OVERRIDES.update(_doc_colors(
    "ocean",
    chart_palette=["#0284C7", "#06B6D4", "#0EA5E9", "#0891B2"],
    overrides={
        "color": {
...
FOREST_OVERRIDES.update(_doc_colors(
    "forest",
    chart_palette=["#059669", "#D97706", "#10B981", "#84CC16"],
    overrides={
        "color": {
...
SUNSET_OVERRIDES.update(_doc_colors(
    "sunset",
    chart_palette=["#EA580C", "#DB2777", "#F59E0B", "#A855F7"],
    overrides={
        "color": {
...
HIGH_CONTRAST_OVERRIDES.update(_doc_colors(
    "high_contrast",
    chart_palette=["#000000", "#444444", "#888888", "#BBBBBB"],
    overrides={
        "color": {
            "heading": _rgb("#000000"), "title": _rgb("#000000"),
