...
from shared.remote_assets import download_remote_asset

# Use shared color conversion to avoid duplication
try:
    from ...shared.color_palette import rgb_to_hex as _rgb_to_hex
...
class DocxRenderer:
    ...
    def __init__(self, tokens: dict, lang: str = "en", output_dir: str = "."):
        self.tokens = tokens
        self.lang = lang
    ...
    def _render_title_block(self, node: dict):
        ...
        run.font.size = t["font"]["size"]["title"]
        run.font.color.rgb = t["color"]["title"]
        run.font.bold = True
